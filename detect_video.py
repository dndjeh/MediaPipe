...
class main2:
    ...
    def Detect_From_Video(filename, instance):
        global instance_it
        ...
        while camera_video.isOpened():
                ...
                frame, landmarks = main2.detectPose(frame, pose_video, display=False)
                ...
                if landmarks:
                        #frame, _ = ttc.pose_detection(landmarks, frame, mp_pose, filename, obj, display=False)
                        ttc.pose_detection(landmarks, frame, mp_pose, filename, instance_it, display=False)
                        #dr.DetectingRePetitiveBehavior(landmarks) # 반복되는 동작 감지
