...
def process_images(folder_path, output_csv, output_image_folder, label):
    ...
    for filename in os.listdir(folder_path):
        if filename.endswith(".jpg") or filename.endswith(".png"):
            ...
            output_image_path = os.path.join(output_image_folder, f"{filename}")
...
def save(label):
    ...
    image_folder_path = f'{"../MediaPipe/Webcam_generate/Webcam_image/"+label+"/input_"+label}'
    output_image_folder = f'{"../MediaPipe/Webcam_generate/Webcam_image/"+label+"/output_"+label}'
