...
# code_path = r'C:\JaeHyeok\Capstone\MediaPipe\PoseCondition.txt'
code_path = 'C:\\JaeHyeok\\Capstone\\MediaPipe\\PoseCondition.txt'
...
full_code = before_code + condition_code + after_code
